...
def fetch_batch():
    ...
    try:
        ...
        cur.execute(
            ...
            "COALESCE(prod_assoc.produto_ids, CASE WHEN l.produto_tipo_id IS NOT NULL THEN ARRAY[l.produto_tipo_id::TEXT]::TEXT[] ELSE ARRAY[]::TEXT[] END), "
            ...
            "LEFT JOIN LATERAL ("
            "  SELECT ARRAY_AGG(lp.produto_tipo_id::TEXT ORDER BY lp.produto_tipo_id) AS produto_ids, "
