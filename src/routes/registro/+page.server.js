...
const GOOGLE_CONFIG_API_URL = backendUrl('/api/auth/google-config');
const GOOGLE_AUTH_API_URL = backendUrl('/api/auth/google');
const REGISTER_API_URL = backendUrl('/api/auth/register');
